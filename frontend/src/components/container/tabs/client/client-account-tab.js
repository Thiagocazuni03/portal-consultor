...
export default class ClientAccountTab {
  ...
  constructor(data = {}) {
   ...
   this.createFieldWrapper({ desktop: 4, mobile: 12 }).append(
      this.buildInput('Condição de Pagamento:', 'name', { desktop: 6, mobile: 12 })
   ),

   this.createFieldWrapper({ desktop: 4, mobile: 12 }).append(
      this.buildInput('Forma de Pagamento:', 'name', { desktop: 6, mobile: 12 })
   ),
